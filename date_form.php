...
if(isset($_POST['input_date']) && isset($_POST['submit']))
  {
    ...
    $holidays = array(
    "2012-9-4", "2012-11-23", "2012-11-22", "2012-12-25", "2012-12-31"
    );
...
<form name="date_form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
<p>
Please enter the desired date in the format of <strong>10/11/12</strong><br /> where 10 is the month (October), 11 is the day, and 12 is the year.</p>
<p>
<label for="input_date">Input Date: </label>
<input type="textarea" name="input_date" />
